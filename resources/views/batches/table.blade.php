        ...
        @foreach($batches as $batch)
            <tr>
                ...
                <td>
                    ...
                    <div class='btn-group'>
                        <a data-toggle="modal" data-target="#batch-view-modal" data-batch_id="{$batch->batch_id}" data-year="{$batch->year}" data-created_at="{$batch->created_at}" data-updated_at="{$batch->updated_at}" class='btn btn-warning btn-xs'><i class="glyphicon glyphicon-eye-open">View</i></a>
